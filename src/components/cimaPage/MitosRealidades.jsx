...
const MitosRealidades = () => (
  <section className="flex flex-col items-center justify-center min-h-[80vh] py-16 px-4 md:px-8">
    <div className="text-center mb-4 max-w-4xl">
      <h2 className="text-3xl md:text-4xl font-bold font-nunito text-[#8E7AB5] mb-6">
        Mitos y Realidades
      </h2>
      <p className="text-base md:text-xl text-[#6D6875] font-quicksand leading-relaxed">
