/*
  ...
  For now, the component uses a gray placeholder square when no image is provided.
*/

// Replace these with real imports once photos are in assets, e.g.:
// import { leaderPhoto, member2Photo } from "../../assets";

const PLACEHOLDER_IMG = null; // swap per member once photos exist

const row1 = [
  {
    name: "TODO: Project Leader Name",
    role: "Project Leader",
    img: PLACEHOLDER_IMG,
  },
  {
